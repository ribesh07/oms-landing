...
export default function FreeTrials() {
  ...
  return (
    <section className="relative py-15 sm:py-15 lg:py-12 px-4 sm:px-6 lg:px-8 overflow-hidden flex items-center">
      ...
      {/* <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="di w-2 h-2 bg-lime-400/30 rounded-full animate-float-slow" style={{top: '20%', left: '10%'}}></div>
          ...
          {/* <div className={`hidden lg:flex justify-center items-center ${isVisible ? 'animate-slide-right opacity-0 delay-400' : 'opacity-0'}`}>
            ...
            <div className={`pt-6 ${isVisible ? 'animate-slide-up opacity-0 delay-500' : 'opacity-0'}`}>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a 
                  href="#" 
                  className="group inline-flex items-center px-6 py-3 bg-green-600 text-white rounded-xl hover:bg-green-800 transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:-translate-y-1 active:scale-95"
                >
                ...
                <a 
                  href="#" 
                  className="group inline-flex items-center px-6 py-3 bg-green-600 text-white rounded-xl hover:bg-greendes-800 transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:-translate-y-1 active:scale-95"
                >
                  <svg className="w-8 h-8 mr-3 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
